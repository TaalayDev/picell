...
class PixelCanvasSurfaceRuntime {
  PixelCanvasSurfaceRuntime() : imageResolver = PixelCanvasSurfaceImageResolver();
  ...
  void update({required Uint8List? backgroundImageBytes, required List<PixelCanvasOnionSkinFrame> onionSkinFrames}) {
    imageResolver.update(backgroundImageBytes: backgroundImageBytes, onionSkinFrames: onionSkinFrames);
  }

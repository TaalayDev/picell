...
class StringsKy extends Strings {
  ...
  @override
  String get features =>
      'Пикселдерди оңой түзөтүү куралдары, \nЖеке түс палитралары, \nТатаал иштер үчүн катмарларды колдоо, \nGIF түзүү үчүн анимация убакыт сызыгы, \nАр кандай форматтарда экспорттоо, \nКоомчулукта бөлүшүү';

  @override
  String get featuresTitle => 'Негизги мүмкүнчүлүктөр:';

  @override
  String get visitWebsite => 'Кошумча маалымат үчүн сайтыма кириңиз:';

  @override
  String get pickAColor => 'Түс тандаңыз';

  @override
  String get colorPicker => 'Түс тандагыч';

  @override
  String get gotIt => 'Түшүндүм';

  @override
  String get undo => 'Артка кайтаруу';

  @override
  String get redo => 'Кайталоо';
  ...
  @override
  String get saveAs => 'Башкача сактоо';

  @override
  String get open => 'Ачуу';

  @override
  String get export => 'Экспорттоо';
  ...
  @override
  String get projects => 'Проекттер';

  @override
  String get lineTool => 'Сызык';

  @override
  String get rectangleTool => 'Тик бурчтук';

  @override
  String get circleTool => 'Айлана';

  @override
  String get about => 'Жөнүндө';

  @override
  String get invalidFileContent => 'Туура эмес файл мазмуну';

  @override
  String get anErrorOccurred => 'Ката кетти';

  @override
  String get tryAgain => 'Кайра аракет кылуу';

  @override
  String get creatingProject => 'Проект түзүлүп жатат...';

  @override
  String get openingProject => 'Проект ачылып жатат...';

  @override
  String get noProjectsFound => 'Проекттер табылган жок';

  @override
  String get createNewProject => 'Жаңы түзүү';
  ...
  @override
  String get projectName => 'Проекттин аты';
  ...
  @override
  String get colorPalette => 'Түс палитрасы';

  @override
  String get currentColor => 'Учурдагы түс';

  @override
  String get add => 'Кошуу';

  @override
  String get layers => 'Катмарлар';
  ...
  @override
  String get feedback_thank_you => 'Пикириңиз үчүн рахмат!';

  @override
  String get feedback_thank_you_message =>
      'Сиздин пикириңиз биз үчүн абдан маанилүү жана тиркемени жакшыртууга жардам берет.';

  @override
  String get feedback_return => 'Кайтуу';

  @override
  String get feedback_help_us => 'Бизге жакшыраак болууга жардам бериңиз';

  @override
  String get feedback_intro =>
      'Сиздин пикириңиз долбоордун өнүгүшү үчүн абдан маанилүү. Сураныч, бир нече суроого жооп бериңиз.';

  @override
  String feedback_answered(int count, int total) {
    return 'Жооп берилди: $totalдан $count';
  }

  @override
  String get feedback_required => 'Милдеттүү';

  @override
  String get feedback_sending => 'Жөнөтүлүүдө...';
  ...
  @override
  String get feedback_excellent => 'Мыкты';

  @override
  String get feedback_yes => 'Ооба';

  @override
  String get feedback_no => 'Жок';

  @override
  String get feedback_text_placeholder => 'Жообуңузду жазыңыз...';

  @override
  String get feedback_q_satisfaction => 'Тиркемеден канчалык канааттанасыз?';
  ...
  @override
  String get feedback_q_price_up_to_5 => '\$5 чейин';
  ...
  @override
  String get feedback_q_usage_daily => 'Күн сайын';

  @override
  String get feedback_q_usage_several_week => 'Жумасына бир нече жолу';

  @override
  String get feedback_q_usage_once_week => 'Жумасына бир жолу';

  @override
  String get feedback_q_usage_several_month => 'Айына бир нече жолу';
  ...
  @override
  String get feedback_q_use_game_design => 'Оюн дизайны';

  @override
  String get feedback_q_use_animation => 'Анимация';

  @override
  String get feedback_q_use_hobby => 'Хобби/көңүл ачуу';

  @override
  String get feedback_q_use_professional => 'Кесиптик иш';
